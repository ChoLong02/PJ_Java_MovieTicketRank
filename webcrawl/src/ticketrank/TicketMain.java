...
public class TicketMain {
	public static void main(String[] args) throws IOException{
		...
		System.out.println("■■ Developer: ChoLong02");
		System.out.println("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
		System.out.println("■■ Movie Ticketing Ranking("+time+")");
		
		// 네이버, 다음 예매 1~10위 영화고유코드를 수집하는 URL
		String naverRank = "https://movie.naver.com/movie/running/current.nhn?order=reserve"; // 네이버 예매 1~10위
		...
		for(int i = 0; i < 10; i++) {
			...
			// href=/movie/bi/mi/basic.nhn?code=187350
		...
		for(int j = 0; j < 10; j++) {
			...
			movieArr[j][2] = href.substring(href.lastIndexOf("=")+1); //다음 코드
		}
...
//		}
		...
		while(true) {
			...
			if(selCode >= 1 && selCode <= 10) {
				...
				System.out.println("You mistyped it. Please enter numbers form 1 to 10 only!!");
				continue;
			}
		}
		...
		System.out.println("▒▒ 전체 댓글수 "+totalCnt+"개, 평균평점 "+df.format(totalAvg)+"점, ");
